*[English version](README.md) — основной язык репозитория английский, это синхронизированный
русский перевод.*
...
```
instagram-carousel/
├── SKILL.md                      # сам skill, английский (основной) — вариант A
├── SKILL.ru.md                    # тот же skill, русский перевод
├── scripts/
...
├── references/
│   ├── design-patterns.md         # структура слайдов, лимиты платформы, паттерны (EN)
│   └── design-patterns.ru.md       # тот же файл, русский перевод
